...
const PlayButtonContainerNoMap = () => {
  const {
        ...
        <button
          ...
          className={`${
            ...
            computerSelectedOption === "rock"
              ? "border-green-500"
              : "border-blue-200"
          } disabled:scale-[1] flex justify-center w-20 h-20 hover:border-blue-200 bg-white sm:w-32 sm:h-32 rounded-full shadow-lg p-4 
...
export default PlayButtonContainerNoMap;
